...
class ButtonWidget: public ActiveRect, public CanvasWidget {
    public:
        ...
        bool CheckBounds();
        ButtonWidget(int16_t x,int16_t y, int16_t h, int16_t w, std::function<void ()> notifyTo, uint32_t btnBackgroundColor=ttgo->tft->color565(164,128,128), bool borders=true);
